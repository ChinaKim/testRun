package com.zhongli.main.zhonglitenghui.volley;
...
public class VolleyRequestQueue{
	...
	private static RequestQueue creatCacheQueue() {
		...
		//设置图片缓存文件大小为40M
		DiskBasedCache basedCache = new DiskBasedCache(file,40 * 1024 * 1024);
		Network network;
		...
		cacheQueue = new RequestQueue(basedCache, network, 15);
		cacheQueue.start();
		return cacheQueue;
	}
